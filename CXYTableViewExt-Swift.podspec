#
#  Be sure to run `pod spec lint CXYTableViewExt-OC.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "@cxy" => "iamhongren@gmail.com" }
  # Or just: spec.author    = "chenxianyin"
  # spec.authors            = { "chenxianyin" => "iamhongren@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/chenxianyin"
